...
export default function EventForm(){
    ...
    const loadEvent = async (id) => {
        const res = await fetch('https://api-eventos-retra-pandemia.herokuapp.com/events/' + id);
    ...
    const handleSubmit = async (e) => {
        ...
        try{
            if(editing){
                await fetch('https://api-eventos-retra-pandemia.herokuapp.com/events/' + params.id, {
                    method: 'PUT',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify(event)
                });
            } else{
                await fetch('https://api-eventos-retra-pandemia.herokuapp.com/events', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify(event)
                });
