...
export default function EventList(){
    ...
    const loadEvents = async () => {
        const res = await fetch('https://api-eventos-retra-pandemia.herokuapp.com/events');
    ...
    const loadPlaces = async () => {
        const res = await fetch('https://api-eventos-retra-pandemia.herokuapp.com/places');
    ...
    const handleDelete = async (id) => {
        await fetch(`https://api-eventos-retra-pandemia.herokuapp.com/events/${id}`, {
            method: 'DELETE'
        });
