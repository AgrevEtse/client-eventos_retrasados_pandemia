...
export default function EventForm(){
    ...
    const loadPlace = async (id) => {
        const res = await fetch('https://api-eventos-retra-pandemia.herokuapp.com/places/' + id);
    ...
    const handleSubmit = async (e) => {
        ...
        try{
            if(editing){
                await fetch('https://api-eventos-retra-pandemia.herokuapp.com/places/' + params.id, {
                    method: 'PUT',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify(place)
                });
            } else{
                await fetch('https://api-eventos-retra-pandemia.herokuapp.com/places', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify(place)
                });
